...
//		System.out.println("Node "+this.id+"Exchanging Message with node "+b.id);
		...
		for(Message m:msg)
		{
			...
			if(Global.prob[this.id][m.dest]<=Global.prob[b.id][m.dest] || b.id==m.dest)
			{
//				System.out.println("Node src prob is"+Global.prob[this.id][m.dest]+" Exchanging for prob "+Global.prob[b.id][m.dest]);
//				m.printMessage();
				this.msgsSent++;	
				b.addMessage(m);
			}
			...
			{
//				System.out.println("Node src prob is"+Global.prob[this.id][m.dest]+" Not Exchanging for prob "+Global.prob[b.id][m.dest]);
//				m.printMessage();
			}
		}
		//this.printAllMessages();
